...
public class UiTestScreen implements Screen {
	...
	public UiTestScreen(GZCGame game) {
		...
		generateLevelButtons(table, new String[]{"data/prototown.tmx", "data/testMap2.tmx", "data/testMap3.tmx", "data/testMap4.tmx", "data/dungeonTest1.tmx", "6", "7", "8", "9", "10"}, new String[]{"1", "2", "3", "4", "D", "6", "7", "8", "9", "10"});
	}
